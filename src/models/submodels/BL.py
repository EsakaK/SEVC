...
from src.models.video_net import ME_Spynet, ResBlock, UNet, bilinearupsacling, bilineardownsacling, \
...
class BL(CompressionModel):
    def __init__(self, anchor_num=4, ec_thread=False, stream_part=1, inplace=False):
        ...
        self.previous_mv_feature = None
        self.previous_frame_y_hat = None
        self.previous_frame_mv_y_hat = None
    ...
    def evaluate(self, x, dpb, q_in_ckpt=False, q_index=None, frame_idx=0):
        return self.forward_one_frame(x, dpb, q_in_ckpt, q_index, frame_idx)
